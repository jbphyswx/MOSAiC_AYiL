...
contains
  subroutine inittestbed
    ...
    call MPI_BCAST(ltb_u        , 1,MPI_LOGICAL,0,comm3d,mpierr)
    call MPI_BCAST(ltb_v        , 1,MPI_LOGICAL,0,comm3d,mpierr)
    call MPI_BCAST(ltb_w        , 1,MPI_LOGICAL,0,comm3d,mpierr)
    call MPI_BCAST(ltb_thl      , 1,MPI_LOGICAL,0,comm3d,mpierr)
    call MPI_BCAST(ltb_qt       , 1,MPI_LOGICAL,0,comm3d,mpierr)
    ! call MPI_BCAST(ltb_latlon   , 1,MPI_LOGICAL,0,comm3d,mpierr)
    ...
    call MPI_BCAST(ltb_sv       , 1,MPI_LOGICAL,0,comm3d,mpierr)
    call MPI_BCAST(ltb_svadv    , 1,MPI_LOGICAL,0,comm3d,mpierr)
    call MPI_BCAST(ltb_svsurf   , 1,MPI_LOGICAL,0,comm3d,mpierr)
    call MPI_BCAST(ltb_calcsv   , 1,MPI_LOGICAL,0,comm3d,mpierr)
    call MPI_BCAST(ltb_spinnudge, 1,MPI_LOGICAL,0,comm3d,mpierr)
    call MPI_BCAST(ltb_clouds   , 1,MPI_LOGICAL,0,comm3d,mpierr)
    call MPI_BCAST(ltb_iadv     , 1,MPI_LOGICAL,0,comm3d,mpierr)
    call MPI_BCAST(ltb_iceinit  , 1,MPI_LOGICAL,0,comm3d,mpierr)
    call MPI_BCAST(ltb_usedate  , 1,MPI_LOGICAL,0,comm3d,mpierr)
    call MPI_BCAST(tb_tauhigh       , 1,MY_REAL    ,0,comm3d,mpierr)
    call MPI_BCAST(tb_t_spinnudge   , 1,MY_REAL    ,0,comm3d,mpierr)     
    call MPI_BCAST(tb_zmin_spinnudge , 1,MY_REAL    ,0,comm3d,mpierr) !#tb
    call MPI_BCAST(tb_zmid_spinnudge , 1,MY_REAL    ,0,comm3d,mpierr) !#tb
    call MPI_BCAST(tb_minzinv   , 1,MY_REAL    ,0,comm3d,mpierr) !#tb
    call MPI_BCAST(tb_maxzinv   , 1,MY_REAL    ,0,comm3d,mpierr) !#tb
...
!        end do
    ...
    call MPI_BCAST(tb_lat     ,ntnudge   ,MY_REAL    ,0,comm3d,mpierr)
    call MPI_BCAST(tb_lon     ,ntnudge   ,MY_REAL    ,0,comm3d,mpierr)
    ...
    call MPI_BCAST(tb_z0h     ,ntnudge   ,MY_REAL    ,0,comm3d,mpierr)! not needed, see: inittimedep
    call MPI_BCAST(tb_z0m     ,ntnudge   ,MY_REAL    ,0,comm3d,mpierr)! not needed, see: inittimedep
    call MPI_BCAST(tb_alb     ,ntnudge   ,MY_REAL    ,0,comm3d,mpierr)! not needed, see: inittimedep
    call MPI_BCAST(tb_Qnet    ,ntnudge   ,MY_REAL    ,0,comm3d,mpierr)
    call MPI_BCAST(tb_seaicefrct,ntnudge ,MY_REAL    ,0,comm3d,mpierr)! not needed, see: inittimedep
    call MPI_BCAST(tb_thls_ocean  ,ntnudge   ,MY_REAL    ,0,comm3d,mpierr)! not needed, see: inittimedep
    call MPI_BCAST(tb_thls_seaice ,ntnudge   ,MY_REAL    ,0,comm3d,mpierr)! not needed, see: inittimedep
    ...
    call MPI_BCAST(tb_ql      ,ntnudge*k1,MY_REAL    ,0,comm3d,mpierr)
    call MPI_BCAST(tb_qi      ,ntnudge*k1,MY_REAL    ,0,comm3d,mpierr)
    call MPI_BCAST(tb_dcl     ,ntnudge*k1,MY_REAL    ,0,comm3d,mpierr)
    call MPI_BCAST(tb_dci     ,ntnudge*k1,MY_REAL    ,0,comm3d,mpierr)    
    call MPI_BCAST(tb_nccn    ,ntnudge*k1,MY_REAL    ,0,comm3d,mpierr)    
    ...
    call MPI_BCAST(tb_qladv   ,ntnudge*k1,MY_REAL    ,0,comm3d,mpierr)
    call MPI_BCAST(tb_qiadv   ,ntnudge*k1,MY_REAL    ,0,comm3d,mpierr)
    ...
    call MPI_BCAST(tb_land_use, mpatch*mpatch, MY_REAL, 0, comm3d, mpierr)
    ...
    call MPI_BCAST(tbrad_qi     ,ntnudge*nknudge,MY_REAL    ,0,comm3d,mpierr)
    ...
    if (nsv>0) then 
      call MPI_BCAST(tb_sv        ,ntnudge*k1*nsv ,MY_REAL    ,0,comm3d,mpierr)! not needed, see: 
      !call MPI_BCAST(tb_svadv     ,ntnudge*k1*nsv ,MY_REAL    ,0,comm3d,mpierr)
    endif 
    ! casting load flags
    call MPI_BCAST(ltb_setccn      , 1,MPI_LOGICAL,0,comm3d,mpierr)
    call MPI_BCAST(ltb_setinp      , 1,MPI_LOGICAL,0,comm3d,mpierr)
    call MPI_BCAST(tb_n_inuc       , 1,MY_REAL    ,0,comm3d,mpierr)
    call MPI_BCAST(tb_a_inuc       , 1,MY_REAL    ,0,comm3d,mpierr)
    call MPI_BCAST(tb_b_inuc       , 1,MY_REAL    ,0,comm3d,mpierr)
    call MPI_BCAST(tb_n_inuc_r     , 1,MY_REAL    ,0,comm3d,mpierr)
    call MPI_BCAST(tb_b_inuc_r     , 1,MY_REAL    ,0,comm3d,mpierr)
    call MPI_BCAST(tb_xday         , 1,MY_REAL    ,0,comm3d,mpierr)

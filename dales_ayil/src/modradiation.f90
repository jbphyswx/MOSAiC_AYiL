...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
  subroutine initradiation
    ...
    namelist/NAMRADIATION/                                      &
      ...
      lCnstZenithTime,cnstZenithTime,                           &
      emissurf,                                                 &
      l_radfullice,l_nc_const,l_nci_const,                      & !#ice
      l_pre_const,l_pde_const,                                  & !#ice
      pre_cval,pde_cval,                                        & !#ice
    ...
    call MPI_BCAST(lCnstZenithTime,1,MPI_LOGICAL,0,comm3d,ierr)
    call MPI_BCAST(cnstZenith, 1,my_real,    0,comm3d,ierr)
    call MPI_BCAST(cnstZenithTime, 1,my_real,    0,comm3d,ierr)
    call MPI_BCAST(emissurf,   1,my_real,    0,comm3d,ierr)
    call MPI_BCAST(pre_cval   ,1,my_real,    0,comm3d,ierr)  ! #ice 
    call MPI_BCAST(pde_cval   ,1,my_real,    0,comm3d,ierr)  ! #ice
    call MPI_BCAST(l_radfullice,1,MPI_LOGICAL,0,comm3d,ierr) ! #ice
    call MPI_BCAST(l_nc_const  ,1,MPI_LOGICAL,0,comm3d,ierr) ! #ice
    call MPI_BCAST(l_nci_const ,1,MPI_LOGICAL,0,comm3d,ierr) ! #ice
    call MPI_BCAST(l_pre_const ,1,MPI_LOGICAL,0,comm3d,ierr) ! #ice
    call MPI_BCAST(l_pde_const ,1,MPI_LOGICAL,0,comm3d,ierr) ! #ice
